...
<HTML>
    ...
    <BODY>
        ...
        <div class="container text-center" style="background-color: black; border: black; opacity: 0.7;">
            <h1 id="sombra">Consultar Produto:</h1><br><br>
            <?php
                include "conexao.php";
                $nome = $_POST["nomeProd"];
            ...
            <p id="sombra"><b>Preço: </b><?php echo $p ?> <br></p>
            <p id="sombra"><b>Cód. do Produto: </b><?php echo $c ?> <br><br></p>
        </div><br><br><br>
        <div class="container">
            <a href="ConsultaProduto1.php"><button style="background-color: black; border: black; color: white;" class="btn btn-primary btn-lg btn-block">Voltar</a></button>
        </div><br><br><br><br><br>
