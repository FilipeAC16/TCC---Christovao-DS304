...
<html>
    ...
    <body>
        ...
        <div class="container text-center">
            <h1 style="color: white; text-shadow: 7px 7px 7px rgba(0,0,0,0.5)"> Alterar Usuario: </h1>
   
        </div>
        <br><br>
        <div class="album py-5 bg-light text-center">
            <div class="container"><br>
                <form method="POST" action="AlterarUsuario2.php">
                    <h4 id="sombra">Nome do usuario:</h4><br>
                    <input style="background-color: black; border: black; color: white;" type="text" size="40" name="nomeUsu" /> &nbsp
                    <input type="submit" style="background-color: black; border: black; color: white;" value="Alterar Usuario" />
                </form>
                <br />
