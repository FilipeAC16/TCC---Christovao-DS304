...
<html>
    ...
    <body>
        ...
        <div class="container text-center" style="background-color: black; border: black; opacity: 0.7;">
            <h1 style="color: white; text-shadow: 7px 7px 7px rgba(0,0,0,0.5)"> Alterar Usuário: </h1><br>
            <?php
                include "conexao.php";
                $n = $_POST["nomeUsu"];
                $e = $_POST["emailUsu"];
            ...
            <p id="sombra">E-mail: <?php echo $e; ?> <br /></p>
            <p id="sombra">CPF: <?php echo $cpf; ?> </p>
            <p id="sombra">Senha: <?php echo $s; ?> </p>
            <p id="sombra">Idade: <?php echo $i; ?> </p>
            <?php
                $sql = "UPDATE usuarios SET nomeUsu = '$n', emailUsu = '$e', cpf = $cpf, senha = '$s', idade = $i WHERE cpf = $cpf"; mysqli_query($mysqli, $sql);
            ?>
            <br />
        </div><br><br>
        <div class="container text-center">
            <button class="btn btn-primary btn-lg btn-block" style="background-color: black; border: black; color: white;"><a href="AlterarUsuario1.php">Voltar</a>
        </div><br><br><br><br><br>
