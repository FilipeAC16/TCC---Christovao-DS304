...
<html>
    ...
    <body>
        ...
        <div class="container text-center">
            <h1 style="color: white; text-shadow: 7px 7px 7px rgba(0,0,0,0.5)"> Consultar Usuario: </h1>
   
        </div>
        <br><br>
        <div class="album py-5 bg-light text-center">
            <div class="container"><br>
              <form method="POST" action="ConsultaUsuario2.php">
                  <h4 id="sombra">Nome do usuário:</h4><br>
                  <input style="background-color: black; border: black; color:white;" type="text" size="40" name="nomeUsu" />
                  <input style="background-color: black; border: black; color: white;" type="submit" value="Consultar Usuario" />
              </form><br><br>
              <button style="background-color: black; border: black; color: white;" class="btn btn-default"><a href="AreaAdmin.php">Voltar</a></button>
            <br><br></div>
        </div><br><br><br><br><br>
