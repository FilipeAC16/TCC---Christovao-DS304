...
<html>
    ...
    <body>
        ...
        <div class="container text-center">
            <h1 style="color: white; text-shadow: 7px 7px 7px rgba(0,0,0,0.5)"> Consultar Produto: </h1>
   
        </div>
        <br><br>
        <div class="album py-5 bg-light text-center">
            <div class="container"><br>
              <form method="POST" action="ConsultaProduto2.php">
                  <h4 id="sombra">Nome do produto:</h4><br>
                  <input style="background-color: black; border: black; color:white;" type="text" size="40" name="nomeProd" />
                  <input style="background-color: black; border: black; color: white;" type="submit" value="Consultar Produto" />
              </form><br><br>
