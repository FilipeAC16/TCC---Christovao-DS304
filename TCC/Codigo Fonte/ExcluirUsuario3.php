...
<HTML>
    ...
    <BODY>
        ...
        <div class="container text-center">
            <h2 id="sombra">Excluir Usuário</h2><br>
            <?php
                Include "conexao.php";
                $resposta = $_POST["resposta"];
                $cpf = $_POST["cpf"];
                if ($resposta == "N")
                    header("Location: ExcluirUsuario1.php");
                else {
                    $sql = "DELETE FROM usuarios WHERE cpf = $cpf";
                    mysqli_query($mysqli, $sql);
                }
            ?>
            <p id="sombra">O usuário foi excluído com sucesso.</P>
            <br /><br />
            <button class="btn btn-default" style="background-color: black; border: black; color: white;"><a href="ExcluirUsuario1.php">Voltar</a>
        </div><br><br><br><br><br>
