...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <h1 style="color: white; text-shadow: 7px 7px 7px rgba(0,0,0,0.5)"> Lista de Usuários - Charff SA.:</h1>
    </div>
    <br><br>
    <?php
        include "conexao.php";
    ...
    <table class="table">
      <thead>
          <tr>
              ...
              <th id="sombra"><b>E-mail:</b></th>
              <th id="sombra"><b>CPF:</b></th>
              <th id="sombra"><b>Idade:</b></th>
              <th id="sombra"><b>Senha:</b></th>
          </tr>
      </thead>
      <?php
        $i = 0;
      ...
      <tbody>
            <tr>
              ...
              <td id="sombra"><?php echo $e; ?></td>
              <td id="sombra"><?php echo $c; ?></td>
              <td id="sombra"><?php echo $i; ?></td>
              <td id="sombra"><?php echo $s; ?></td>
            </tr>
            <?php
                $i++;
              }
