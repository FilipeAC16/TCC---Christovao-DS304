...
<HTML>
    ...
    <BODY>
        ...
        <div class="container text-center" style="background-color: black; opacity: 0.7;">
            <h1 id="sombra">Cadastrar Usuário</h1><br>
            <?php
                Include "conexao.php";
                $n = $_POST["nomeUsu"];
                $e = $_POST["emailUsu"];
                ...
                $s = $_POST["senha"];
                $i = $_POST["idade"];
                $sql = "INSERT INTO usuarios(nomeUsu, emailUsu, cpf, senha, idade) VALUES ( '$n', '$e', '$c', '$s', $i)";
                mysqli_query($mysqli, $sql);
            ?>
            <h3 id="sombra"><b> O seguinte usuário foi cadastrado com sucesso: </b></h3><br>
            <p id="sombra"><b>Nome:</b> <?php echo $n; ?><br /></p>
            <p id="sombra"><b>E-mail:</b> <?php echo $e; ?><br /></p>
            <p id="sombra"><b>CPF:</b> <?php echo $c; ?><br /></p>
            <p id="sombra"><b>Senha:</b> <?php echo $s; ?> <br /><br /></p>
            <p id="sombra"><b>Idade:</b> <?php echo $i; ?> <br /><br /></p>
        </div><br><br><br>
        <div class="container">
            <button class="btn btn-primary btn-lg btn-block" style="background-color: black; border: black; color: white;"><a href="AreaAdmin.php">Voltar</a></button>
        </div><br><br><br><br><br>
